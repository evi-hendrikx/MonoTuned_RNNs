...
def evaluate_net(results_dir, repetitions, assessed_per="event",x0="duration",y0="period", do_plotting = True,control_condition=None):
    ...
    :param net: network
    :param random_phase: True if net was trained with random phase
    :param dataset_idx: None if network was trained on full dataset
    :param timing_idx: dataset element to investigate
    :return:
    """
