...
for variable in ["mean_X","mean_Y","maj","min","ratio","theta","exp"]:
    ...
    if variable == "theta":
        ...
        # print(stats[variable]['between_layers'][posthoc_name_field]["posthoc_corrected"])
    ...
    name_dict = {'results_section':'parmeterPlotsInfo_afterBerkeley','plots':'Harvey2020','variable': variable}
