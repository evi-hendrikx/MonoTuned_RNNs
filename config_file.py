...
RESULTS_DIR = os.path.join(DIR_PATH, "backedupResults")
...
SCRAMBLE_SHIFTED = True # True means that NOT all shifted similarly movies of the same timing are shifted similarly (first scramble, then shift over phases), RATHER scambled after shift
DATASET_IDX = None
FORCE_LENGTH = True
